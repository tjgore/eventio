           ...
           <section className="bg-transparent bg-center bg-no-repeat bg-cover" style={{ backgroundImage: `url(${content.fields.image.fields.file.url})` }}>
                <div className="bg-grad-pink h-full">
                    <div className="pt-24 lg:pt-48 pb-48 text-white text-center p-8 lg:px-32">
                        <h4 className="font-bold text-2xl w-64 m-auto text-pink-500">{content.fields.subtitle}</h4>
                        ...
                        <div className="mt-12">
                            { content.fields.buttonOneText ? (<a href="#" className="rounded py-2 px-4 border-4 border-white text-white hover:border-gray-300 font-bold m-3">{content.fields.buttonOneText}</a>) : null }
                        </div>
                    </div>
                </div>
            </section>
